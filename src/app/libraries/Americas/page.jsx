...
export default async function Home() {
  ...
  return (
    <div>
      <h1 className="flex flex-col items-center h-[50px] justify-center m-4 bg-sky-600 text-white capitalize mt-20">countries in the Americas</h1>
     ...
     <footer className="flex flex-col items-center h-[50px] justify-center m-4 bg-sky-600 text-white">
      <p>{`We have ${countries.length} countries in the Americas`}</p>
     </footer>
